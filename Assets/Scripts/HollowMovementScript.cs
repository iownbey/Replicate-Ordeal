...
public class HollowMovementScript : MonoBehaviour
{
    ...
    void Attack(float MoveDirection)
    {
    ...
    public bool Grounded()
    {
        ...
        return Physics2D.Raycast(groundTransform.position, Vector2.down, groundCheckY, groundLayer) 
    ...
    public bool Roofed()
    {
        ...
        return Physics2D.Raycast(roofTransform.position, Vector2.up, roofCheckY, groundLayer) 
